...
public class SpecialityResourceTest {
    ...
    public void createSpeciality() throws Exception {
        ...
        assertThat(testSpeciality.getLastUpdated().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_LAST_UPDATED);
    }
    ...
    public void updateSpeciality() throws Exception {
        ...
        assertThat(testSpeciality.getLastUpdated().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_LAST_UPDATED);
    }
