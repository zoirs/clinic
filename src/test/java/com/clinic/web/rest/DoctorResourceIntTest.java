...
public class DoctorResourceIntTest {
    ...
    private static final String DEFAULT_FIO = "AAAAA";
    private static final String UPDATED_FIO = "BBBBB";
    ...
    public void createDoctor() throws Exception {
        ...
        assertThat(testDoctor.getFio()).isEqualTo(DEFAULT_FIO);
    ...
    public void updateDoctor() throws Exception {
        ...
        Doctor testDoctor = doctors.get(doctors.size() - 1);
        assertThat(testDoctor.getFio()).isEqualTo(UPDATED_FIO);
