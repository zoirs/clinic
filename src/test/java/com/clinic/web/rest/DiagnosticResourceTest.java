...
public class DiagnosticResourceTest {
    ...
    public void createDiagnostic() throws Exception {
        ...
        assertThat(testDiagnostic.getLastUpdated().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_LAST_UPDATED);
    }
    ...
    public void updateDiagnostic() throws Exception {
        ...
        assertThat(testDiagnostic.getLastUpdated().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_LAST_UPDATED);
    }
